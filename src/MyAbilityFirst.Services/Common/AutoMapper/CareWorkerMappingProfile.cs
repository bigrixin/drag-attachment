...
namespace MyAbilityFirst.Services.Common
{
	public class CareWorkerMappingProfile : Profile
	{
		...
		public CareWorkerMappingProfile(IPresentationService presentationService, IAttachmentService attachmentService)
		{
		...
		private void MapCareWorker()
		{
			CreateMap<CareWorker, CareWorkerDetailsViewModel>()
				...
				.ForMember(dest => dest.CareWorkerID, opt => opt.MapFrom(src => src.ID));
			...
			CreateMap<CareWorker, CareWorkerAttachmentViewModel>()
				.ForMember(dest => dest.CareWorkerID, opt => opt.MapFrom(src => src.ID))
				.ForMember(dest => dest.AttachmentList, opt => opt.MapFrom(src => this._presentationService.GetCarerAttachmentList()))
